...
echo "  - Generated layer: generated_layer_${MASKED_IDX}.png"
echo "  - All layers (GT visible): generated_layer_${MASKED_IDX}_all_layers_gt.png"
echo "  - All layers (model pred): generated_layer_${MASKED_IDX}_all_layers_model_pred.png"
echo "  - Ground truth: ground_truth_layer_${MASKED_IDX}.png"
echo ""
echo "Note:"
echo "  - 'GT visible' shows ground truth visible layers + generated masked layer"
echo "  - 'model pred' shows model predictions for ALL layers (including visible)"
echo "============================================"

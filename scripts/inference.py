...
def get_args():
    ...
    parser.add_argument('--t5_path', default='/workspace/PixArt-alpha/PixArt-alpha', type=str)
    parser.add_argument('--tokenizer_path', default='./PixArt-alpha/sd-vae-ft-ema', type=str)
